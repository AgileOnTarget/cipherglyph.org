 ...
 *      can write GLY1-shaped bytes. Only the second one earns HPP VERIFIED.
...
export const CLASS_TEXT = {
  [CLASS.GENUINE]: {
    badge: "HPP VERIFIED",
    note: "Issued by BadGlyph, and the presence burn checked out.",
  },
  [CLASS.ISSUED_UNVERIFIED]: {
    badge: "VERIFICATION UNAVAILABLE",
    note:
      "Issued by BadGlyph, but the burn could not be checked just now. This is not a failed check, it is an unfinished one.",
  },
  [CLASS.THIRD_PARTY]: {
