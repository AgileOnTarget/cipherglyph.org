...
function unreachable() {
  ...
  return {
    ...
    message: isHttpsPage
      ? "Cannot reach the local treasury service from the public HTTPS page. For local testing, open the local faucet preview with npm run app. For public use, this needs a hosted HTTPS treasury endpoint."
